...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public TestSerilizable __Gen_Delegate_Imp16(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                TestSerilizable __gen_ret = (TestSerilizable)translator.GetObject(L, errFunc + 1, typeof(TestSerilizable));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
